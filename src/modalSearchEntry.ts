...
export const ModalSearchEntry = GObject.registerClass(
class ModalSearchEntry extends ModalDialog.ModalDialog {
    _entry: St.Entry;
    _kpId: number;

    constructor(title: string = 'Type something', placeholder: string = '…', f : (txt : string) => void) {
